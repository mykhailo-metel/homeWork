...
public class EUBank extends Bank{
    ...
    private final int USD_LIMIT_OF_WITHDRAWAL = 2000;
    private final int EURO_LIMIT_OF_WITHDRAWAL = 2200;
    private final int USD_LIMIT_OF_FUNDING = 10000;
    private final int EURO_LIMIT_OF_FUNDING = 20000;
    private final int USD_MONTHLY_RATE = 0;
    private final int EURO_MONTHLY_RATE = 1;
